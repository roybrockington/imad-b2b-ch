...
const aboutUsKeys = [
    { key: 'modernLogistics', image: 'modernLogistics.jpg' },
    { key: 'heartOfEurope', image: 'heartOfEurope.jpg' },
    { key: 'salesServiceTeams', image: 'salesServiceTeams.jpg' }
];
                ...
                <ul className="flex flex-col md:flex-row w-full gap-4 my-8">
                    {aboutUsKeys.map(item =>
                        <li className="md:w-1/3 flex flex-col gap-4" key={item.key}>
                            ...
                            <Image src={`/${item.image}`} alt={t(`aboutUs.${item.key}.title`)} height={500} width={400} className="w-full rounded-lg"/>
